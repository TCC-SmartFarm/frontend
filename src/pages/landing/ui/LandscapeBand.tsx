import farmLandscapeImg from "../../../assets/landscape-image.jpg";

export const LandscapeBand = () => {
  return (
    <section className="px-6 pb-14">
      <div className="relative mx-auto h-120 max-w-7xl overflow-hidden rounded-3xl shadow-xl">
        <img
          src={farmLandscapeImg}
          alt="Paisagem da Fazenda Serra Verde"
          className="absolute inset-0 h-full w-full object-cover"
        />

        <div className="absolute bottom-6 left-7 z-10 text-white">
          <h2 className="text-[28px] font-semibold italic leading-[1.1] tracking-tight">
...
export const FarmLandscape = () => (
  ...
  >
    ...
    <path
      d="M0 230 Q 200 200,400 215 T 800 200 Q 1000 195,1280 220 L1280 280 L0 280 Z"
      fill="#7d9670"
      opacity="0.6"
    />
    <path
      d="M0 280 Q 250 250,500 270 T 950 260 Q 1150 255,1280 280 L1280 350 L0 350 Z"
      fill="url(#hill-2)"
      opacity="0.85"
    />
    ...
    <path
      d="M0 350 Q 400 320,800 340 T 1280 350 L1280 480 L0 480 Z"
      fill="url(#field-grad)"
    />
